...
namespace OnLineShop.Db.Migrations
{
    ...
    [Migration("20240327093621_EditDefaultProducts")]
    partial class EditDefaultProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnLineShop.Db.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Category = 1,
                            Cost = 543m,
                            Description = "Невероятно добрая книжка, познкомит юного читателя с путешествиями Кошки Мисс Табиты Пушистый хвост, к которой нагрянули незваные гости - мышки Шустри и Шурши.",
